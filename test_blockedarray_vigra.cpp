...
struct BlockedArrayTestSuite
: public vigra::test_suite
{
    BlockedArrayTestSuite()
    : vigra::test_suite("BlockedArrayTestSuite")
    {
        add( testCase(&BlockedArrayTest::testdim3_uint8));
        add( testCase(&BlockedArrayTest::testdim3_float32));
        add( testCase(&BlockedArrayTest::testdim5_float32));
        add( testCase(&BlockedArrayTest::testdim3_int64));
    }
};
